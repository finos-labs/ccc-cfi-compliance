@PerService @object-storage @CCC.ObjStor @tlp-clear @tlp-green @tlp-amber @tlp-red @CCC.ObjStor.CN01.AR04
Feature: CCC.ObjStor.CN01.AR04
  ...
  @Policy
  Scenario: Test policy for object write access control
    When I attempt policy check "no-public-access" for control "CCC.ObjStor.CN01" assessment requirement "AR04" for service "{ServiceType}" on resource "{ResourceName}" and provider "{Provider}"
    Then "{result}" is true
