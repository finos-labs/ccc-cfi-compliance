@CCC.Core @tlp-green @tlp-amber @tlp-red @CCC.Core.CN01
Feature: CCC.Core.CN01.AR01
  ...
  @Behavioural @PerPort @tls @object-storage @vpc
  ...
  @Policy @PerService @object-storage @vpc
  ...
  @Policy @PerService @load-balancer @vpc
