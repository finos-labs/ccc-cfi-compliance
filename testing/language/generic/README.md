...
This package provides a generic set of Cucumber/Godog step definitions for testing in Go. It creates a mini-language for CCC (Common Cloud Controls) compliance testing that leverages Go's concurrency primitives and supports both synchronous and asynchronous operations.

## Features

- Variable assignment and resolution
- Reflection-based function and method calls
- Object and array validation
- Boolean and nil checks
- Error handling with panic recovery
- Asynchronous operations with timeouts (goroutines, channels)
